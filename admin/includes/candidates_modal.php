            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="firstname" name="firstname" pattern="[A-Za-z].{2,30}" title = "Enter only alphabets, minimum 2 characters and maximum 30 characters" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="lastname" name="lastname" pattern="[A-Za-z].{2,30}" title = "Enter only alphabets, minimum 2 characters and maximum 30 characters" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="position" name="position" pattern="[A-Za-z].{2,30}" title = "Enter only alphabets, minimum 2 characters and maximum 30 characters" required>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="email" name="email" data-sb-validations="email">
                    </div>
                </div>
				<div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Edit Candidate Info</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" id="dob" name="dob" data-sb-validations="phone">
                    </div>
                </div>
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo</label>
